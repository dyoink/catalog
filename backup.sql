...
\restrict yFiHyWiJ7p23JFuZiTZG2nhqgBq1st3ufn0N7WqalyuFqYr12sce4lHdtaNp2Zh
...
--
-- Name: partners_short_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: partners_short_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: posts_short_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: posts_short_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: product_finances; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: products_short_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: products_short_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.site_settings (
    ...
    hero_background_image character varying(500),
    ...
    hero_button_url character varying(500),
...
--
-- Name: partners short_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: posts short_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: products short_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: partner_categories; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: product_contents; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: product_finances; Type: TABLE DATA; Schema: public; Owner: -
--
...
1e669665-12bb-48bb-bc5c-b50edb50611d	1
...
COPY public.site_settings (id, company_name, logo, address, phone, email, facebook, show_facebook, zalo, show_zalo, youtube, show_youtube, tiktok, show_tiktok, telegram, show_telegram, show_hotline, bank_name, bank_number, bank_owner, background_color, primary_color, navbar_color, footer_color, footer_text, show_footer, hero_background_image, show_banners, show_categories, show_featured_products, show_latest_posts, show_partners, featured_products_count, latest_posts_count, show_nav_products, show_nav_knowledge, show_nav_partners, show_nav_cart, hero_title, hero_subtitle, hero_description, hero_button_text, hero_button_url, about_title, about_content, about_image, default_meta_title, default_meta_description, default_og_image, google_analytics_id, facebook_pixel_id, footer_about_text, copyright_text, email_enabled, smtp_host, smtp_port, smtp_use_ssl, smtp_user, smtp_password, smtp_from_email, smtp_from_name, notification_email, chat_auto_reply_message, updated_at) FROM stdin;
b57a2a7f-4b8e-4702-9f0e-4273965c8cdc	Fanto	/uploads/settings/99e9ccb32dfb4d0cbabcdbde47afb399.png	\N	0353785710	contact@cataloga.com	\N	t	\N	t	\N	f	\N	f	\N	f	t	\N	\N	\N	#F9F9F9	#55B3D9	#2563eb	#1F2937	Precision Engineering.	t	\N	t	t	t	t	t	8	6	t	t	t	t	\N	\N		\N	\N	\N		\N	\N	\N	\N	\N	\N		\N	f	\N	587	t	\N	\N	\N	\N	\N	xin chào	2026-05-13 09:35:28.791681+00
\.
...
SELECT pg_catalog.setval('public.page_views_id_seq', 150, true);


--
-- Name: partners_short_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: posts_short_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: products_short_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: chat_sessions chat_sessions_guest_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: partner_categories partner_categories_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: partners partners_short_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: posts posts_short_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_finances product_finances_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_metadata product_metadata_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: products products_short_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_activity_logs_severity; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_product_finances_featured; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_product_metadata_slug; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: chat_sessions trg_chat_sessions_updated; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: site_settings trg_settings_updated; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: partners partners_partner_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: posts posts_knowledge_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: product_finances product_finances_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict yFiHyWiJ7p23JFuZiTZG2nhqgBq1st3ufn0N7WqalyuFqYr12sce4lHdtaNp2Zh
